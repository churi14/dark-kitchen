    ...
    <main className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4">
      <div className="w-full max-w-[360px]">
        ...
        <div className="text-center mb-8">
          <div className="w-14 h-14 bg-accent rounded-full flex items-center justify-center mx-auto mb-3 text-2xl
        ...
        <form onSubmit={handleLogin} className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-[16px] p-6 flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-[#242424] border border-[#2e2e2e] rounded-[10px] px-3.5 py-3
                         text-[14px] text-white placeholder:text-gray-600 outline-none
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full h-11 bg-accent rounded-[10px] text-white font-bold text-[14px] mt-1
